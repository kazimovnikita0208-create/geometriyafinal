...
⏰ *Правила отмены:*
• Вечерние занятия - отмена за 4 часа
• Дневные занятия - отмена до 21:00 предыдущего дня
  `.trim();
...
3. Выберите зал, направление и время
